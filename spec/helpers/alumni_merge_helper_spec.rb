  ...
  describe "generate_alumni_email_from_emails" do
    it "calculates nothing if alumni mail is already available" do
      ...
      alumni_row.each do |row| 
        expect(AlumniMergeHelper.generate_alumni_email(row)[:alumnimail]).to eq 'student'
      end
    end
    ...
    it "calculates the alumnimail correctly from the private email" do
      ...
      alumni_row.each do |row| 
        expect(AlumniMergeHelper.generate_alumni_email(row)[:alumnimail]).to eq 'private_email'
      end
    end
    ...
    it "calculates the alumnimail correctly from a additional email" do
      ...
      alumni_row.each do |row| 
        expect(AlumniMergeHelper.generate_alumni_email(row)[:alumnimail]).to eq 'additional_mail'
      end
    end
    ...
    it "generates alumni mail from row correctly" do
      ...
      raw_data.each_with_index do |raw_item, index|
        ...
        alumni_row.each do |row|
          expect(AlumniMergeHelper.generate_alumni_email(row)[:alumnimail]).to eq expected[index]
        end
      end
    end
  end
