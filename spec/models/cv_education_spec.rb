...
describe CvEducation do
  ...
  describe "querying" do
    before(:each) do
      @oldest = FactoryBot.create(:cv_education, start_date: Date.today - 100.days, end_date: Date.today - 30.days)
      @middle = FactoryBot.create(:cv_education, start_date: Date.today - 90.days, end_date: Date.today - 30.days)
      @newer = FactoryBot.create(:cv_education, start_date: Date.today - 90.days, end_date: Date.today - 15.days)
      @newest = FactoryBot.create(:cv_education, start_date: Date.today - 90.days, end_date: Date.today - 20.days, current: true)
    end
