class JobOffersController < ApplicationController
  ...
  private
    ...
    def job_offer_params
      parameters = params.require(:job_offer).permit(:description, :title, :employer_id, :state_id, :room_number, :start_date, :end_date, :compensation, :flexible_start_date, :responsible_user_id, :time_effort, :student_id, :vacant_posts, { programming_language_ids: []}, {language_ids: []})
