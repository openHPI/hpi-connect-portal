class JobOffersController < ApplicationController
  ...
  private
    ...
    def job_offer_params
      parameters = params.require(:job_offer).permit(:description, :title, :offer_as_pdf, :employer_id, :state_id, :category_id, :graduation_id, :start_date, :end_date, :compensation, :flexible_start_date, :time_effort, :student_id, { programming_language_ids: []}, {language_ids: []})
